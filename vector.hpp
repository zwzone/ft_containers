...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/19 10:26:33 by zwina             #+#    #+#             */
/*   Updated: 2023/01/19 10:26:35 by zwina            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
  ...
  explicit vector ( const allocator_type& alloc )
    ...
    _end_C(nullptr)
  { }
  explicit vector ( size_type count, const_reference val = value_type(), const allocator_type& alloc = allocator_type() )
    : _alloc(alloc),
    _start(nullptr),
    _end_S(nullptr),
    _end_C(nullptr)
