...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/19 10:28:18 by zwina             #+#    #+#             */
/*   Updated: 2023/01/19 10:28:21 by zwina            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void vector_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft_v2.resize(15);
        /*----------------------------------------------------*/
        if(v1.capacity() != ft_v1.capacity()) std::cout << "v1 = " << v1.capacity() << ",ft_v1 = " << ft_v1.capacity();
        if(v2.capacity() != ft_v2.capacity()) std::cout << "v2 = " << v2.capacity() << ",ft_v2 = " << ft_v2.capacity();
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        EQUAL((s1 == ft_s1 && z1 == ft_z1) && (s2 == ft_s2 && z2 == ft_z2) && (s3 == ft_s3 && z3 == ft_z3));
    }
